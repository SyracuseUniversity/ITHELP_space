---
title: "HIPAA Compliant Zoom Invite Users"
confluence_id: "159943159"
space_key: "ITHELP"
...
This new process is assigning users with an email address of '**<netid>+shz@syr.edu**'. For example: '**bdchabot+shz@syr.edu**'. This will be the email address used within the HIPAA Zoom system.
...
You'll receive an email from Zoom and this email will reference the '**<netid>+shz@syr.edu**' address. For example:

![](https://answers.atlassian.syr.edu/wiki/download/attachments/159943159/ZoomHIPAAemail.png?api=v2)

You will need to click on the link to complete the process. Then you will be asked to activate, and use Sign In with SSO:

![](https://answers.atlassian.syr.edu/wiki/download/attachments/159943159/ZoomHIPAAactivate.png?api=v2)

Use your Syracuse University NetID and password:

![](https://answers.atlassian.syr.edu/wiki/download/attachments/159943159/SSOlogin.png?api=v2)

Once you log in, you can click on the profile icon and view your profile. You will see your Preferred Name and your email address will be '**<netid>+shz@syr.edu**'. This is an indicator that you are in the HIPAA Zoom system.

![](https://answers.atlassian.syr.edu/wiki/download/attachments/159943159/ZoomHIPAAclientProfile.png?api=v2)
...
![](https://answers.atlassian.syr.edu/wiki/download/attachments/159943159/ZoomEmail2.png?api=v2)

If you have any questions about the process, please contact the [ITS Help Desk](http://its.syr.edu/supportsvc).

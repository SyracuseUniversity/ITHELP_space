---
title: "Sharing Files in Google Drive"
confluence_id: "159951297"
space_key: "ITHELP"
...
- [Overview](#SharingFilesinGoogleDrive-Overview)
- [Shared Drives](#SharingFilesinGoogleDrive-SharedDrives)
  - [Shared Drive Permissions](#SharingFilesinGoogleDrive-SharedDrivePermissions)
  - [Individual File Permissions](#SharingFilesinGoogleDrive-IndividualFilePermissions)
  - [Shared Drive FAQ](#SharingFilesinGoogleDrive-SharedDriveFAQ)
- [My Drive Shared Files](#SharingFilesinGoogleDrive-MyDriveSharedFiles)
  - [Transferring File or Folder Ownership](#SharingFilesinGoogleDrive-TransferringFileorFolderOwnership)
  - [Copying Shared Files](#SharingFilesinGoogleDrive-CopyingSharedFiles)
  - [My Drive Shared Files FAQ](#SharingFilesinGoogleDrive-MyDriveSharedFilesFAQ)

**Files in Shared Drives and files shared in My Drive are NOT the same!** Shared files from a My Drive are tied to an owner, whereas files in a Shared Drive are owned by the University. If a user leaves the University, files that exist in a Shared Drive will not be affected, whereas files that have been shared out through a user's My Drive will be lost.

## Overview

---

There are many ways to collaborate and share files amongst users with your g.syr.edu Google Workspace Drive account. The recommended method for collaboration is through the use of Shared Drives.
...
2. In the sidebar on the left showing file details, select **Manage access**
   ...
   ![](https://answers.atlassian.syr.edu/wiki/download/attachments/159951297/Screen%20Shot%202022-12-06%20at%201.11.54%20PM.png?api=v2)
